...
* **Режим TUN настраивается сам**: служба ставится при первом запуске одним запросом прав, выбор
  пользователя не стирается, а провал старта виден на экране, а не только в логе.
